...
class ModelExtensionOpenBayEtsyOrder extends Model {
	...
	private function create($order) {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "order` SET
		   ...
		   `fullname`				  = '" . $this->db->escape((string)$customer_name['fullname']) . "',
		   `lastname`				  = '" . $this->db->escape((string)$customer_name['surname']) . "',
		   `email`				  	  = '" . $this->db->escape((string)$order->buyer_email) . "',
		   `telephone`				  = '',
		   `fax`				  	  = '',
		   `payment_fullname`		  = '" . $this->db->escape((string)$customer_name['fullname']) . "',
		   ...
		   `payment_code`	  		  = '',
		   `shipping_fullname`		  = '" . $this->db->escape((string)$customer_name['fullname']) . "',
